"""Fail-fast local Qwen experiment for the numbered line-block action space."""
...
def run_local_qwen_block_p1(
    *,
    ...
    try:
        ...
        raise ContractError("block P1 inputs are unreadable") from exc
    ...
    adapter = LineBlockRewriteAdapter(generator=generator)
    ...
    if condition_ids is not None:
        ...
        if not condition_ids <= known:
            raise ContractError("unknown block experiment condition filter")
        conditions = [
            condition
